# Contributing to Midwest Maps

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

The following are guidelines for contributing to Midwest Maps.
...
[What should I know before I get started?](#what-should-i-know-before-i-get-started)
  ...
  * [Midwestern History Association](#midwestern-history-association)
...
This repository specifically hosts the project **Mapping Midwest**, designed to map demographic and population change in the American Midwest. The project was created in partnership with the Midwestern History Association.

## How Can I Contribute?

### Reporting Bugs

This section guides you through submitting a bug report for Mapping Midwest. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer:, and find related reports :mag_right:.
...
* **Perform a [cursory search](https://github.com/issues?q=+is%3Aissue+user%3Amapping+midwest)** to see if the problem has already been reported. If it has, add a comment to the existing issue instead of opening a new one.
...
This section guides you through submitting an enhancement suggestion for Mapping Midwest, including completely new features and minor improvements to existing functionality. Following these guidelines helps maintainers and the community understand your suggestion :pencil: and find related suggestions :mag_right:.

Before creating enhancement suggestions, please check [this list](#before-submitting-an-enhancement-suggestion) as you might find out that you don't need to create one. When you are creating an enhancement suggestion, please [include as many details as possible](#how-do-i-submit-a-good-enhancement-suggestion). Fill in [the template](ISSUE_TEMPLATE.md), including the steps that you imagine you would take if the feature you're requesting existed.

#### Before Submitting An Enhancement Suggestion

* **Perform a [cursory search](https://github.com/issues?q=+is%3Aissue+user%3Amapping-midwest)** to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Unsure where to begin contributing to Mapping Midwest? You can start by looking through these `beginner` and `help-wanted` issues:
